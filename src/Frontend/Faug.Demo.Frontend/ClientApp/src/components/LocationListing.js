...
export class LocationListing extends Component {
                ...
                <tbody>
                    {locations.map(location =>
                        <tr key={location.city + "_" + location.lat + "_" + location.lng}>
                            <td><Link to={`/locations/${location.city}`}>{location.city}</Link></td>
                            <td>{location.lat}</td>
                            <td>{location.lng}</td>
    ...
    render() {
        let contents = this.state.loading
            ? <p><em>Loading...</em></p>
            : LocationListing.renderLocationsTable(this.state.locations);
